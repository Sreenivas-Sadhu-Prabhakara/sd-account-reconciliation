package com.bank.bian.accountreconciliation.model;
...
/**
 * The BIAN control record for this service domain: "Account Reconciliation Procedure".
 *
 ...
 * to its asset type (Account Reconciliation). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Account Reconciliation Procedure";
